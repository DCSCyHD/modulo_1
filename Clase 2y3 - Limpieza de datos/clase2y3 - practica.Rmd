...
#### **e.** Crear una tabla que contenga, para cada provincia:
...
#### **f.** Dado el siguiente código, agregar a la base una columna que exprese la proporción que representa cada situacion de inmueble respecto al totalde inmuebles:
