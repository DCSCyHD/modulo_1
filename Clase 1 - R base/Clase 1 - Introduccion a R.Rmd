...
![fuente: Salas, C. (2008). ¿ Por qué comprar un programa estadístico si existe R?. Ecología austral, 18(2), 223-231](img/Salas_porqueR.PNG)   
...
```{r echo=TRUE}
# Vector numérico
A <- c(1, 2, 2,2,3,2,1, 2, 1, 1, 1)
class(A)

# Vector de caracteres
B <- c("Lunes","Viernes","Viernes","Jueves",
...
**Crear o transforma una variable en *factor* nos será sumamente útil para realizar gráficos siguiendo un orden deseado para las categorías** 

```{r echo=TRUE}
# Una propiedad del factor: las etiquetas.
dias_factor <- factor(B,
                 levels = c("Lunes",
                            "Martes",
                            "Miercoles",
                            "Jueves",
